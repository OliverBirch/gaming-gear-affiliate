...
export const freshnessTickets: FreshnessTicket[] = [
  ...
  {
    id: "cs910-missing-image-2026-08-10",
    type: "missing-pro-image",
    slug: "cs910",
    label: "910 (cs910) — pro image could not be downloaded",
    question: "910's player image is not hosted on prosettings.net's direct-URL CDN pattern and no og:image was found on their player page. Needs manual sourcing.",
    context: {
      esport: "cs2",
      proSlug: "cs910",
      sourceUrl: "https://prosettings.net/players/cs910/",
      instructions: "Download 910's player photo (square, min 220x220px). Save as public/images/pros/cs910.png. Acceptable sources: prosettings.net HTML page (right-click → save), Liquipedia, HLTV, or the player's Twitter/X. Then add billede: \"/images/pros/cs910.png\" to the pro's entry in pros.ts and resolve this ticket with the source URL used.",
    },
    createdAt: "2026-08-10",
  },
  {
    id: "forsaken-missing-image-2026-08-10",
    type: "missing-pro-image",
    slug: "forsaken",
    label: "f0rsakeN (forsaken) — pro image could not be downloaded",
    question: "f0rsakeN's player image is not hosted on prosettings.net's direct-URL CDN pattern and no og:image was found on their player page. Needs manual sourcing.",
    context: {
      esport: "valorant",
      proSlug: "forsaken",
      sourceUrl: "https://prosettings.net/players/forsaken/",
      instructions: "Download f0rsakeN's player photo (square, min 220x220px). Save as public/images/pros/forsaken.png. Acceptable sources: prosettings.net HTML page (right-click → save), Liquipedia, VLR.gg, or the player's Twitter/X. Then add billede: \"/images/pros/forsaken.png\" to the pro's entry in pros.ts and resolve this ticket with the source URL used.",
    },
    createdAt: "2026-08-10",
  },
  {
    id: "zmjkk-missing-image-2026-08-10",
    type: "missing-pro-image",
    slug: "zmjkk",
    label: "ZmjKK (zmjkk) — pro image could not be downloaded",
    question: "ZmjKK's player image is not hosted on prosettings.net's direct-URL CDN pattern and no og:image was found on their player page. Needs manual sourcing.",
    context: {
      esport: "valorant",
      proSlug: "zmjkk",
      sourceUrl: "https://prosettings.net/players/zmjkk/",
      instructions: "Download ZmjKK's player photo (square, min 220x220px). Save as public/images/pros/zmjkk.png. Acceptable sources: prosettings.net HTML page (right-click → save), Liquipedia, VLR.gg, or the player's Twitter/X/Weibo. Then add billede: \"/images/pros/zmjkk.png\" to the pro's entry in pros.ts and resolve this ticket with the source URL used.",
    },
    createdAt: "2026-08-10",
  },
  {
    id: "xs3xycake-missing-image-2026-08-10",
    type: "missing-pro-image",
    slug: "xs3xycake",
    label: "xS3xyCake (xs3xycake) — pro image could not be downloaded",
    question: "xS3xyCake's player image is not hosted on prosettings.net's direct-URL CDN pattern and no og:image was found on their player page. Needs manual sourcing.",
    context: {
      esport: "r6",
      proSlug: "xs3xycake",
      sourceUrl: "https://prosettings.net/players/xs3xycake/",
      instructions: "Download xS3xyCake's player photo (square, min 220x220px). Save as public/images/pros/xs3xycake.png. Acceptable sources: prosettings.net HTML page (right-click → save), Liquipedia, or the player's Twitter/X. Then add billede: \"/images/pros/xs3xycake.png\" to the pro's entry in pros.ts and resolve this ticket with the source URL used.",
    },
    createdAt: "2026-08-10",
  },
  {
